...
physics_processes = {
        ...
        'Zvv_ht100':{ 'label':'Z#rightarrow#nu#nu', 
                      ...
                      'ordering': 4,
                      'xsec' : 280.5,
                      'files':[dataDir+"ZJetsToNuNu_HT-100To200_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root"],
                      },
        'Zvv_ht200':{ 'label':'Z#rightarrow#nu#nu', 
                      ...
                      #'xsec' : 77.7,
                      'xsec' : 78.36,
                      'files':[dataDir+"ZJetsToNuNu_HT-200To400_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root"],
                      },
        'Zvv_ht400':{ 'label':'Z#rightarrow#nu#nu', 
                      ...
                      #'xsec' : 10.71,
                      'xsec' : 10.94,
                      'files':[dataDir+"ZJetsToNuNu_HT-400To600_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root"],
                      },
        'Zvv_ht600':{ 'label':'Z#rightarrow#nu#nu', 
                      ...
                      #'xsec' : 4.089,
                      'xsec' : 4.20,
                      'files':[dataDir+"ZJetsToNuNu_HT-600ToInf_13TeV-madgraph+RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1+AODSIM.root"],
                      },
        ...
        'QCD_200To300': { 'label':'Top quark + diboson + qcd',
                          'datacard':'others',
                          'color' : colors.keys()[3],
                          'ordering': 2,
                          'xsec' : 1735000.0,
        ...
        'QCD_300To500': { 'label':'Top quark + diboson + qcd',
                          'datacard':'others',
                          'color' : colors.keys()[3],
                          'ordering': 2,
                          'xsec' : 366800.0,
        ...
        'QCD_500To700': { 'label':'Top quark + diboson + qcd',
                          'datacard':'others',
                          'color' : colors.keys()[3],
                          'ordering': 2,
                          'xsec' : 29370.0,
        ...
        'QCD_700To1000': { 'label':'Top quark + diboson + qcd',
                           'datacard':'others',
                           'color' : colors.keys()[3],
                           'ordering': 2,
                           'xsec' : 6524.0,
        ...
        'QCD_1000To1500': { 'label':'Top quark + diboson + qcd',
                            'datacard':'others',
                            'color' : colors.keys()[3],
                            'ordering': 2,
                            'xsec' : 1064.0,
...
#                            },
        'others': { 'label':'Top quark + diboson + qcd',
                    'datacard':'others',
                    'color' : colors.keys()[3],
                    'ordering': 2,
                    'xsec' : 831.76,
        ...
        'antitop': { 'label':'Top quark + diboson + qcd',
                    'datacard':'others',
                    'color' : colors.keys()[3],
                    'ordering': 2,
                    'xsec' : 26.22,
        ...
        'top': { 'label':'Top quark + diboson + qcd',
                    'datacard':'others',
                    'color' : colors.keys()[3],
                    'ordering': 2,
                    'xsec' : 44.07,
        ...
        'antitop_5f': { 'label':'Top quark + diboson + qcd',
                    'datacard':'others',
                    'color' : colors.keys()[3],
                    'ordering': 2,
                    'xsec' : 35.6,
        ...
        'top_5f': { 'label':'Top quark + diboson + qcd',
                    'datacard':'others',
                    'color' : colors.keys()[3],
                    'ordering': 2,
                    'xsec' : 35.6,
        ...
        'WW' : { 'label':'Top quark + diboson + qcd',
                 'datacard':'others',
                 'color':colors.keys()[3],
                 'ordering': 2,
                 'xsec' : 63.21,
        ...
        'ZZ' : { 'label':'Top quark + diboson + qcd',
                 'datacard':'others',
                 'color':colors.keys()[3],
                 'ordering': 2,
                 'xsec' : 10.32,
        ...
        'WZ' : { 'label':'Top quark + diboson + qcd',
                 'datacard':'others',
                 'color':colors.keys()[3],
                 'ordering': 2,
                 'xsec' : 22.82,
        ...
        'data2': { 'label':'Data without Halo Filters',
                   'datacard':'data',
                   'color': 1,
                   'ordering': 6,
                   'xsec' : 1.0,
                   'files':[dataDir+'monojet_MET+Run2015D.root',],   
                   },


        'data3': { 'label':'Data with Halo Filters',
                  'datacard':'data',
                  'color': 1,
                  'ordering': 7,    
                  'xsec' : 1.0,
                  
                  'files':['/afs/cern.ch/user/d/dsperka/public/forZeynep/Data_NoNoise.root',],

                  #'files':[dataDir+'monojet_MET+Run2015D.root',],

                  #'files':[dataDir+'MET+Run2015D-PromptReco-v3+AOD.root',
                  #         dataDir+'MET+Run2015D-PromptReco-v4+AOD.root'],
                  #
                  },
#        'data': { 'label':'Data + Filters',
#                   'datacard':'data',
#                   'color': 1,
#                   'ordering': 8,
#                   'xsec' : 1.0,
